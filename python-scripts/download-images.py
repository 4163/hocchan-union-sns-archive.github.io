...
# Step 1: Get the current working directory and create the '@horieyui_staff' folder inside 'Media' if it doesn't exist
cwd = os.getcwd()
media_folder = os.path.join(cwd, 'Media', '@horieyui_staff')
        ...
        for i, url in enumerate(urls_list):
            ...
            try:
                ...
                if response.status_code == 200:
                    # Save the image to the '@horieyui_staff' folder inside 'Media'
